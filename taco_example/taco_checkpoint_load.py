...
from glottal_mel_model_v4 import TransformerModel,ntokens,emsize,nhead,d_hid,nlayers,dropout,ag,optimizer,testset_loader,criterion,print_spectrogram
...
checkpoint = torch.load(r"C:\Users\xelloss\Downloads\checkpoint.pt")
